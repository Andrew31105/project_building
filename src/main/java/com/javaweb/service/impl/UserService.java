...
public class UserService implements IUserService {
    ...
    public UserDTO register(RegisterDTO registerDTO) {
        ...
        userEntity = userConverter.ConvertToEntity(registerDTO);
        ...
        customerEntity.setFullname(registerDTO.getFullName());
        customerEntity.setIs_active(1);
        customerEntity.setEmail(registerDTO.getEmail());
        customerEntity.setPhone(registerDTO.getPhone());
